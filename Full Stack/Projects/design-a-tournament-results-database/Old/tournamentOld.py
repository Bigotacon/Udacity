...
def reportMatch(winner, loser):
    ...
    db = connect()
    c = db.cursor()
    c.execute("INSERT INTO Matches_Tbl (player_id, opponent_id, result) VALUES (%s,%s,1)", (winner, loser))
    c.execute("INSERT INTO Matches_Tbl (player_id, opponent_id, result) VALUES (%s,%s,0)", (loser, winner))
    db.commit()
    db.close()
