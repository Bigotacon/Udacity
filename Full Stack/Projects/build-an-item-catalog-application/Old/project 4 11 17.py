# client id - 251425158101-4cdrp3pqurcl8bc4jkacah49sbnb2avc.apps.googleusercontent.com
# client secret - KZEkuZjSAdBUW6bVXjNIhxle
...
def gconnect():
    ...
    login_session['urername'] = data['name']
    login_session['picture'] = data['picture']
    login_session['email'] = data['email']
	# Add provider to Google Session
	login_session['provider'] ='google'

	# see if user exists, if it doesn't then make oine
...
def deleteRestaurant(restaurant_id):
    ...
    if restaurantToDelete.user_id != login_session['user_id']:
        return "<script>function myFunction()"\
            ...
            " Please create your own restuarant in order to delete.');} "\
            "</script><body onload='myFunction()''>"
    if request.method == 'POST':
